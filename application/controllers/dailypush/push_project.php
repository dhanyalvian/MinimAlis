<?php
/**
 * Description of Push_project
 * 
 * @author  dhanyalvian@gmail.com
 */

class Push_project extends MY_Controller {
    protected $_pageController = 'push_project';
    protected $_pageTitle = 'Push Project';
    protected $_pageActive = 'dailypush';
    protected $_pageViews = 'dailypush/push_project';
    //protected $_pageBreadcumb = array (
    //    array ('title' => 'Daily Push', 'url' => ''),
    //    array ('title' => 'Push Project', 'url' => '')
    //);
    protected $_additionalCss = array ('bootstrap.dataTables', 'bootstrap-datetimepicker.min');
    protected $_additionalJs = array ('jquery.dataTables.min', 'jquery.dataTables.paging.min', 'moment', 'bootstrap-datetimepicker.min', 'push_project');
    protected $_pushProjectModel = 'dailypush/push_project_model';
    ...
    public function getGridDataTables() {
        $this->load->model($this->_pushProjectModel);
        $response = $this->push_project_model->getGridDataTables();
    ...
    public function getComboboxService() {
        $this->load->model($this->_pushProjectModel);
        return $this->push_project_model->getComboboxService();
    }
    ...
    public function save() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model($this->_pushProjectModel);
            $result = $this->push_project_model->save();
    ...
    public function edit() {
        ...
        $this->load->model($this->_pushProjectModel);
        $row = $this->push_project_model->edit($id);
    ...
    public function delete() {
        $id = $this->input->post('id', true);
        $this->load->model($this->_pushProjectModel);
        $result = $this->push_project_model->delete($id);
...
/* End of file push_project.php */
/* Location: ./application/controllers/dailypush/push_project.php */