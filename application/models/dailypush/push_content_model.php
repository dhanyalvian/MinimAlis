<?php
/**
 * Description of Push_content_model
 * 
 * @author  dhanyalvian@gmail.com
 */

class Push_content_model extends MY_Model {
	 ...
	 */
	$aColumns = array ('a.service', 'a.content_label', 'a.content', 'a.author', 'DATE_FORMAT(a.datepublish, \'' . $this->dateTimeFormatMysql . '\') datepublish', 'a.id');
	$aColumnsX = array ('service', 'content_label', 'content', 'author', 'datepublish', 'id');
...
/* End of file push_content_model.php */
/* Location: ./application/models/dailypush/push_content_model.php */
