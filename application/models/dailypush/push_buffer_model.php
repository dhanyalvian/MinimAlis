<?php
/**
 * Description of Push_buffer_model
 * 
 * @author  dhanyalvian@gmail.com
 */

class Push_buffer_model extends MY_Model {
	...
	$aColumns = array ('a.pid', 'a.src', 'a.dest', 'a.operator_id', 'a.service', 'a.subject', 'a.message', 'FORMAT(a.price, 0) price', 'a.stat', 'DATE_FORMAT(a.created, \'' . $this->dateTimeFormatMysql . '\') created', 'a.tid', 'a.type', 'a.id');
	$aColumnsX = array ('pid', 'src', 'dest', 'operator_id', 'service', 'subject', 'message', 'price', 'stat', 'created', 'tid', 'type', 'id');
        //$aColumnsY = array ('a.service', 'a.content_label', 'a.content', 'a.author', 'a.datepublish', 'a.id');
    ...
    public function edit($id) {
        $this->dbPush->select('id, service, content_label, content, author, notes, DATE_FORMAT(datepublish, \'' . $this->dateFormatMysql . '\') datepublish', false);
...
/* End of file push_buffer_model.php */
/* Location: ./application/models/dailypush/push_buffer_model.php */
