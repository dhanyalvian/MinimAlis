<div>
    ...
    <div class="table-responsive dataTables_wrapper" role="grid">
        <table id="pushContentDataTables" class="display table table-bordered table-hover table-striped">
            <thead>
                <tr>
                    <th style="width:150px;">Service Name</th>
                    <th style="width:200px;">Content Label</th>
                    <th>Content</th>
                    <th style="width:150px;">Author</th>
                    <th style="width:150px;">Date Publish</th>
